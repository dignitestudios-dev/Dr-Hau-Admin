 ...
 oxycodone: "",
  ...
  const handleBackendData = (backendData) => {
    setFormData(prevState => ({
      ...
      mumpsDate: backendData.mumpsDate ? backendData.mumpsDate.split("T")[0] : "",  // Handle date
      rubellaDate: backendData.rubellaDate ? backendData.rubellaDate.split("T")[0] : "",
      rubeolaDate: backendData.rubeolaDate ? backendData.rubeolaDate.split("T")[0] : "",
      varicellaDate: backendData.varicellaDate ? backendData.varicellaDate.split("T")[0] : "",
      hepatitisDate: backendData.hepatitisDate ? backendData.hepatitisDate.split("T")[0] : "",
...
>
  ...
  <span>{isEditing ? "Editing.." : "Edit"}</span>
      ...
      <form onSubmit={handleSubmit} className="bg-white shadow-md rounded p-6">
        ...
        <div className="grid grid-cols-2 gap-6 mb-4">
  <div>
    <label className="block text-sm font-medium text-black">Mumps IgG Titer</label>
    <select
  ...
  <div>
    <label className="block text-sm font-medium text-black">Mumps Date</label>
    <input
      type="date"
  ...
  <div>
    <label className="block text-sm font-medium text-black">Rubella IgG Titer</label>
    <select
  ...
  <div>
    <label className="block text-sm font-medium text-black">Rubella Date</label>
    <input
      type="date"
      value={formData.rubellaDate ? formData.rubellaDate.split("T")[0] : ""}
  ...
  <div>
    <label className="block text-sm font-medium text-black">Rubeola IgG Titer</label>
    <select
  ...
  <div>
    <label className="block text-sm font-medium text-black">Rubeola Date</label>
    <input
      type="date"
      value={formData.rubeolaDate ? formData.rubeolaDate.split("T")[0] : ""}
  ...
  <div>
    <label className="block text-sm font-medium text-black">Varicella IgG Titer</label>
    <select
      value={formData.varicellaImmunity}
      onChange={(e) => handleChange("varicellaImmunity", e.target.value)}
      className="w-full border rounded p-2 text-black"
      disabled={!isEditing}
    >
      <option value={true}>Immune</option>
  ...
  <div>
    <label className="block text-sm font-medium text-black">Varicella Date</label>
    <input
      type="date"
      value={formData.varicellaDate ? formData.varicellaDate.split("T")[0] : ""}
  ...
  <div>
    <label className="block text-sm font-medium text-black">Hepatitis B Sab Titer</label>
    <select
      value={formData.hepatitisImmunity}
      onChange={(e) => handleChange("hepatitisImmunity", e.target.value)}
      className="w-full border rounded p-2 text-black"
      disabled={!isEditing}
    >
      <option value={true}>Immune</option>
  ...
  <div>
    <label className="block text-sm font-medium text-black">Hepatitis Date</label>
    <input
      type="date"
      value={formData.hepatitisDate ? formData.hepatitisDate.split("T")[0] : ""}
...
<div className="grid grid-cols-2 gap-6 mb-4">
  ...
  <div>
    <label className="block text-sm font-medium text-black">Physical Exam Date</label>
    <input
      type="date"
      value={formData.physicalExamDate ? formData.physicalExamDate.split("T")[0] : ""}
  ...
  <div>
    <label className="block text-sm font-medium text-black">Physical Exam Note</label>
    <input
      type="text"
  ...
  <div>
    <label className="block text-sm font-medium text-black">T-spot IGRA TB Test #1</label>
    <select
  ...
  <div>
    <label className="block text-sm font-medium text-black">T-spot Test #1 Date</label>
    <input
      type="date"
      value={formData.tspot1Date ? formData.tspot1Date.split("T")[0] : ""}
  ...
  <div>
    <label className="block text-sm font-medium text-black">T-spot Test #1 Note</label>
    <input
      type="text"
  ...
  <div>
    <label className="block text-sm font-medium text-black">T-spot IGRA TB Test #2</label>
    <select
  ...
  <div>
    <label className="block text-sm font-medium text-black">T-spot Test #2 Date</label>
    <input
      type="date"
      value={formData.tspot2Date ? formData.tspot2Date.split("T")[0] : ""}
  ...
  <div>
    <label className="block text-sm font-medium text-black">T-spot Test #2 Note</label>
    <input
      type="text"
...
<div className="grid grid-cols-2 gap-6 mb-4">
  ...
  <div>
    <label className="block text-sm font-medium text-black">Hepatitis B Vaccination #1 Date</label>
    <input
      type="date"
      value={formData.hepatitisBVaccination1Date}
      onChange={(e) => handleChange("hepatitisBVaccination1Date", e.target.value)}
      className="w-full border rounded p-2 text-black"
      disabled={!isEditing}
    />
  </div>
  {/* <div>
    ...
    <input
      ...
      onChange={(e) => handleChange("hepatitisBVaccination1Note", e.target.value)}
      className="w-full border rounded p-2 text-black"
  ...
  <div>
    <label className="block text-sm font-medium text-black">Hepatitis B Vaccination #2 Date</label>
    <input
      type="date"
  ...
  {/* <div>
    ...
    <input
      ...
      onChange={(e) => handleChange("hepatitisBVaccination2Note", e.target.value)}
      className="w-full border rounded p-2 text-black"
  ...
  <div>
    <label className="block text-sm font-medium text-black">Hepatitis B Vaccination #3 Date</label>
    <input
      type="date"
      value={formData.hepatitisBVaccination3Date}
      onChange={(e) => handleChange("hepatitisBVaccination3Date", e.target.value)}
      className="w-full border rounded p-2 text-black"
      disabled={!isEditing}
    />
  </div>
  {/* <div>
    ...
    <input
      ...
      onChange={(e) => handleChange("hepatitisBVaccination3Note", e.target.value)}
      className="w-full border rounded p-2 text-black"
  ...
  {/* MMR Vaccination #1 */}
  <div>
    <label className="block text-sm font-medium text-black">MMR Vaccination #1 Date</label>
    <input
      type="date"
      value={formData.mmrVaccination1Date}
      onChange={(e) => handleChange("mmrVaccination1Date", e.target.value)}
      className="w-full border rounded p-2 text-black"
      disabled={!isEditing}
    />
  </div>
  {/* <div>
    ...
    <input
      ...
      onChange={(e) => handleChange("mmrVaccination1Note", e.target.value)}
      className="w-full border rounded p-2 text-black"
      placeholder="Enter note for first dose"
      disabled={!isEditing}
    />
  ...
  {/* MMR Vaccination #2 */}
  <div>
    <label className="block text-sm font-medium text-black">MMR Vaccination #2 Date</label>
    <input
      type="date"
      value={formData.mmrVaccination2Date}
      onChange={(e) => handleChange("mmrVaccination2Date", e.target.value)}
      className="w-full border rounded p-2 text-black"
      disabled={!isEditing}
    />
  </div>
  {/* <div>
    ...
    <input
      ...
      onChange={(e) => handleChange("mmrVaccination2Note", e.target.value)}
      className="w-full border rounded p-2 text-black"
      placeholder="Enter note for second dose"
      disabled={!isEditing}
    />
  ...
  <div>
    <label className="block text-sm font-medium text-black">Varicella Vaccination #1 Date</label>
    <input
      type="date"
      value={formData.varicellaVaccination1Date}
      onChange={(e) => handleChange("varicellaVaccination1Date", e.target.value)}
      className="w-full border rounded p-2 text-black"
      disabled={!isEditing}
    />
  </div>
  {/* <div>
    ...
    <input
      ...
      onChange={(e) => handleChange("varicellaVaccination1Note", e.target.value)}
      className="w-full border rounded p-2 text-black"
      placeholder="Enter note for first dose"
      disabled={!isEditing}
    />
  ...
  <div>
    <label className="block text-sm font-medium text-black">Varicella Vaccination #2 Date</label>
    <input
      type="date"
      value={formData.varicellaVaccination2Date}
      onChange={(e) => handleChange("varicellaVaccination2Date", e.target.value)}
      className="w-full border rounded p-2 text-black"
      disabled={!isEditing}
    />
  </div>
  {/* <div>
    ...
    <input
      ...
      onChange={(e) => handleChange("varicellaVaccination2Note", e.target.value)}
      className="w-full border rounded p-2 text-black"
      placeholder="Enter note for second dose"
      disabled={!isEditing}
    />
  ...
  {/* Tdap Vaccination */}
  <div>
    <label className="block text-sm font-medium text-black">Tdap Vaccination Date</label>
    <input
      type="date"
      value={formData.tdapVaccinationDate}
      onChange={(e) => handleChange("tdapVaccinationDate", e.target.value)}
      className="w-full border rounded p-2 text-black"
      disabled={!isEditing}
    />
  </div>
  {/* <div>
    ...
    <input
      ...
      onChange={(e) => handleChange("tdapVaccinationNote", e.target.value)}
      className="w-full border rounded p-2 text-black"
  ...
  <div>
    <label className="block text-sm font-medium text-black">Influenza Vaccination Date</label>
    <input
      type="date"
      value={formData.influenzaVaccinationDate}
      onChange={(e) => handleChange("influenzaVaccinationDate", e.target.value)}
      className="w-full border rounded p-2 text-black"
      disabled={!isEditing}
    />
  </div>
  {/* <div>
    ...
    <input
      ...
      onChange={(e) => handleChange("influenzaVaccinationNote", e.target.value)}
      className="w-full border rounded p-2 text-black"
