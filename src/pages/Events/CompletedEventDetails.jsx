...
import CompletedEventAppointmentsTable from '../../components/Events/CompletedEventAppointmentsTable';


 
const CompletedEventDetails = () => {
 ...
 className="text-[24px] text-gray-700 mr-3" />
      ...
      <div className="bg-white shadow-md rounded-md p-6">
        ...
        {activeTab === 'details' ? (
          <div>
            <h4 className="text-[20px] font-bold text-black mb-4">Vaccination Appointment <span className="bg-green-600 text-white px-3 py-2 text-[12px] rounded-full">Completed</span></h4>
...
Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc non eleifend odio, suscipit aliquam erat. Quisque eu fermentum tortor. Lorem ipsum dolor sit amet, consectetur adipiscing elit. </p>
          ...
          <CompletedEventAppointmentsTable />
        )}
      </div>
...
export default CompletedEventDetails;
