...
const CreateProfile = () => {
  ...
  return (
    <div className="w-full h-auto p-6 bg-gray-100 overflow-auto">
      ...
      <div className="bg-white w-full h-auto mb-8 p-4 lg:p-10 sm:p-6 rounded-lg shadow-lg text-black">
        <form onSubmit={handleSubmit}>
          ...
          <div className="mt-6 flex justify-center sm:justify-start mb-6">
            <button
              type="submit"
              className="bg-black w-full sm:w-[150px] lg:mt-2 text-white py-2 px-6 rounded-lg"
            >
              Save Profile
            </button>
          </div>
